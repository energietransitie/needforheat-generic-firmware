...
NOTE: Do not use the 'ESP32DEV' environment for M5CoreINK board! It does work but some features specific to the M5CoreINK will not be included in the firmware what cause problems during run-time.  
